...
class CreonBalance(metaclass=Singleton):
    def get_balance(self):
        ...
        cpBalance = getattr(creonClients, 'CpTd6033')
        ...
        for i in range(cpBalance.GetHeaderValue(7)):
            ...
            stock = MyBalanceStockListObject(code= stock_code, name=stock_name, price=stock_price, qty=stock_qty, profit=stock_yield)
